...
$stmt = $conn->prepare("SELECT t.*, te.name as teacher_name, c.name as class_name, s.name as status_name 
                        FROM tests t 
...
$stmt = $conn->prepare("SELECT COUNT(*) as count FROM questions q 
...
<body>
    <div class="container">
        <div class="navbar">
            ...
            <div>
                <a href="tests.php" style="margin-right: 10px;">Kembali</a>
        ...
        <div class="card">
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td><strong>Skor Maksimal:</strong></td>
